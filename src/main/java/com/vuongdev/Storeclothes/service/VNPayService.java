...
import com.vuongdev.Storeclothes.configuration.VNPayConfig;
import com.vuongdev.Storeclothes.configuration.VNPayUtils;
...
public class VNPayService {
    ...
    public void updateOrderWithVNPayTxnRef(String txnRef) {
        ...
        // Tránh xử lý lại nếu khách reload trang callback
